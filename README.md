...
You can learn more in the [Create NextJS App documentation](https://nextjs.org/docs/getting-started).

To learn NextJS, check out the [Next documentation](https://nextjs.org/).
